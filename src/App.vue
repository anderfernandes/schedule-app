    ...
    <div class="ui basic segment">
      <div class="ui blue icon message">
        ...
        <div class="content">
          ...
          <p>
            <a href="/go-beyond/app">Click here</a> to download it!
          </p>
        </div>
      </div>
      <div class="ui blue icon message">
        ...
        <div class="content">
          <div
            class="header"
          >Are you planning on visiting us after {{ format(new Date(end), 'EEEE, MMMM d') }}?</div>
          <p>
            <a href="/public-calendar">Click here</a> to see our Public Calendar, which contains all our future confirmed events as they are added.
          </p>
        </div>
      </div>
    </div>
    <div class="ui basic segment" v-for="(day, i) in days" :key="i" v-show="day.events.length > 0">
      <div class="ui dividing header">
        <i class="calendar alternate outline icon"></i>
        <div class="content">{{ format(new Date(day.date), 'EEEE, MMMM d') }}</div>
      </div>
